...
/**
 * Removes the specified number of elements from the end (length - 1 index) of an
 ...
 * @returns A new array containing all elements except the last n.
 */
export const dropRight = <T>(arr: ArrayLike<T>, n: number): T[] | Error => {
  ...
  return Array.prototype.slice.call(arr, 0, arr.length - nValue);
};
