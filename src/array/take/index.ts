...
/**
 * Returns the specified number of elements from the beginning (0th index) of an array-like.
 *
 ...
 * @returns A new array containing the first n elements from arr.
 */
export const take = <T>(arr: ArrayLike<T>, n: number): T[] | Error => {
  ...
  return Array.prototype.slice.call(arr, 0, nValue);
};
