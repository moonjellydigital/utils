...
describe('product', () => {
  test.each([
    ...
    const result = product(arg) as Error;
  ...
  test('should return the value at index 0 if the length is 1', () => {
